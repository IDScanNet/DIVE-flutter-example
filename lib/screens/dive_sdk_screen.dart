...
/// DIVE SDK Tab Screen
class DiveSdkScreen extends StatefulWidget {
  const DiveSdkScreen({super.key});

  @override
  State<DiveSdkScreen> createState() => _DiveSdkScreenState();
}

class _DiveSdkScreenState extends State<DiveSdkScreen> {
  ...
  Future<void> _startDiveSdk() async {
            ...
            children: [
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  child: const Text('Start', style: TextStyle(fontSize: 17)),
                ),
              ),
